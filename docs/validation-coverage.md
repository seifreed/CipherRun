...
| POODLE variants, OpenSSL 0-Length, CVE-2016-2107 | Active probe | Pinned OpenSSL 1.0.1c multi-version CBC fixture covers 0-Length as `inconclusive` | Pinned OpenSSL 1.1.1m TLS 1.2 control | CipherRun + OpenSSL client smoke | 0-Length is exercised but cannot be confirmed remotely without observing memory disclosure; POODLE timing variants and CVE-2016-2107 still require dedicated vulnerable implementations |
