...
| Opossum (CVE-2022-0778) | Certificate parsing / timeout probe | Not remotely attestable | `modern-tls` as a reachability control | CipherRun | CVE-2022-0778 is a client-side OpenSSL parser flaw; CipherRun uses rustls for this probe and therefore reports inconclusive rather than claiming a remote positive. A genuine vulnerable/patched parser harness must run locally in the client process, not against a network listener |
