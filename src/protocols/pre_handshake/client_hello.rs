...
impl PreHandshakeScanner {
    ...
    fn get_cipher_suites(&self) -> Vec<u16> {
        vec![
            0x1301, 0x1302, 0x1303, 0xc02f, 0xc030, 0xcca8, 0xc02b, 0xc02c, 0xcca9, 0x009c,
    ...
    fn build_extensions(&self) -> Result<Vec<u8>> {
        ...
        extensions.extend_from_slice(&[
            0x00, 0x0a, 0x00, 0x0c, 0x00, 0x0a, 0x00, 0x1d, 0x00, 0x17, 0x00, 0x18, 0x00,
            0x19, 0x01, 0x00,
        ]);

        extensions.extend_from_slice(&[
            0x00, 0x0d, 0x00, 0x1e, 0x00, 0x1c, 0x04, 0x03, 0x05, 0x03, 0x06, 0x03, 0x08,
